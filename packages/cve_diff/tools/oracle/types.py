...
A verdict is the outcome of comparing our pipeline's pick
...
class Verdict(str, Enum):
    ...
    def is_pass(self) -> bool:
        """Does this verdict count as a correct pass?"""
...
class OracleVerdict:
    ...
    cve_id: str
    picked_slug: str        # our bench's pick (may be empty for UnsupportedSource)
    picked_sha: str         # our bench's pick (may be empty for UnsupportedSource)
    verdict: Verdict
